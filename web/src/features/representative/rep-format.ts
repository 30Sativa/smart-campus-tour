...
export const TOUR_LABEL: Record<TourState, { label: string; tone: Tone }> = {
  Scheduled: { label: 'Đang nhận đăng ký', tone: 'blue' },
  Ready: { label: 'Đã chốt danh sách', tone: 'ink' },
  Running: { label: 'Đang diễn ra', tone: 'lime' },
