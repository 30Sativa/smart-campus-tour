import { ALL_ROLES, REPRESENTATIVE_HOME, homePathForRole, isAdminRole, isRepresentativeRole, isStaffRole, normalizeRole, roleLabel } from './roles'
 ...
 */
export type AreaId = 'public' | 'staff' | 'admin' | 'representative'
