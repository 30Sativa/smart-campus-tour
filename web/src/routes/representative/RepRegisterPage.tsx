...
function RegisterForm({ tour, registration }: { tour: RepresentativeTour; registration: RepresentativeRegistrationDetail | null }) {
  ...
  if (!mode) {
    ...
    return (
      <div className="rp-ctn rp-section">
        <div className="rp-callout rp-callout--info" role="status">
          <Info size={18} />
          <div>
  ...
  const errorBanner = error && (
    <div className={error.code === 'StaleData' || error.code === 'NotAllowed' ? 'rp-callout rp-callout--warn' : 'rp-callout rp-callout--danger'} role="alert">
      ...
      <div className="rp-layout">
        <div className="rp-stack">
          ...
          {mode === 'resubmit' && registration?.rejectionReason && step < 2 && (
            <div className="rp-callout rp-callout--danger">
              <AlertTriangle size={18} />
