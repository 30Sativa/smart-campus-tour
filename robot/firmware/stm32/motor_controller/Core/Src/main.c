...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PB0_SONAR1_TRIG_Pin|PB11_SONAR2_TRIG_Pin|PB13_SONAR3_TRIG_Pin|PB15_SONAR4_TRIG_Pin|PB6___IMU_SCL_BITBANG_Pin|PB7___IMU_SDA_BITBANG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB0_SONAR1_TRIG_Pin PB11_SONAR2_TRIG_Pin PB13_SONAR3_TRIG_Pin PB15_SONAR4_TRIG_Pin PB6___IMU_SCL_BITBANG_Pin PB7___IMU_SDA_BITBANG_Pin */
  GPIO_InitStruct.Pin = PB0_SONAR1_TRIG_Pin|PB11_SONAR2_TRIG_Pin|PB13_SONAR3_TRIG_Pin|PB15_SONAR4_TRIG_Pin|PB6___IMU_SCL_BITBANG_Pin|PB7___IMU_SDA_BITBANG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
