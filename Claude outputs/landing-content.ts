...
export const railItems: RailItem[] = [
  ...
  },
  {
    ...
    body: 'Trạng thái robot và môi trường được đồng bộ liên tục qua ROS Bridge về bản đồ 3D.',
    image: '/images/digital-twin.jpg',
  ...
  },
  {
    ...
    body: 'Whisper nhận giọng nói, LLM xử lý hội thoại, TTS trả lời lại bằng ngôn ngữ khách chọn.',
    image: '/images/ai-assistant.jpg',
  ...
  },
  {
    ...
    body: 'FastAPI nhận yêu cầu đặt tour, phân bổ robot và quản lý hàng đợi cho cả ngày.',
    image: '/images/booking-app.jpg',
...
export const platformPillars: PlatformPillar[] = [
  {
    ...
    benefit: 'Điều hướng chính xác và tránh vật cản theo thời gian thực.',
    stack: ['ROS 2 Humble', 'Nav2', 'SLAM Toolbox', 'MoveIt 2'],
  },
  {
    id: 'ai',
    icon: 'cpu',
    title: 'Chuỗi xử lý đa ngôn ngữ',
    benefit: 'Nghe, hiểu và trả lời khách bằng giọng nói tự nhiên.',
    stack: ['Whisper STT', 'LLM hội thoại', 'Coqui TTS'],
  },
  {
    id: 'backend',
    icon: 'server',
    title: 'Booking và dispatch API',
    benefit: 'Nhận đặt tour, phân bổ robot và điều phối hàng đợi tự động.',
    stack: ['FastAPI', 'PostgreSQL', 'Redis', 'AWS EC2'],
  },
  {
    id: 'frontend',
    icon: 'layout',
